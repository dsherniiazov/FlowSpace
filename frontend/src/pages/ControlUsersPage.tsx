...
export function ControlUsersPage(): JSX.Element {
  ...
  const [userPendingDeletion, setUserPendingDeletion] = useState<UserPublic | null>(null);
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="Delete user?"
        description={`Delete ${userPendingDeletion?.email ?? "this user"}? This action cannot be undone.`}
